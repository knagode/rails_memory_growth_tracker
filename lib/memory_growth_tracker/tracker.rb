  ...
  class Tracker
    class << self
      ...
      def clear_all_data
        ...
        MemoryGrowthTracker::Middleware.reset_data
      end
      ...
      def stats
        ...
        tracked_count = MemoryGrowthTracker::Middleware.tracked_requests_count
        total_count = MemoryGrowthTracker::Middleware.total_requests_count
        skipped_count = MemoryGrowthTracker::Middleware.skipped_requests_count
